...
export function TopBar() {
  ...
  return (
    <header className="flex shrink-0 flex-col border-b border-line bg-panel/60">
      {/* Linha 1: contexto da working copy + ações globais */}
      <div className="flex h-14 items-center gap-3 px-4" data-tauri-drag-region>
      ...
      {/* Linha 2: abas contextuais em faixa própria (não disputam espaço com o contexto). */}
      {isContextual && wc && (
        <div
          className="flex h-11 items-center justify-center border-t border-line/60 px-4"
