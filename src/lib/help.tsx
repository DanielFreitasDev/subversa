...
export const HELP = {
  ...
  changes: {
    ...
    points: [
      ...
      "“Reverter” descarta as mudanças locais, voltando ao que estava antes. Use o ícone de reverter (↺) no próprio arquivo — ou, na barra abaixo da mensagem de commit, os botões que revertem os marcados ou a working copy inteira. Passe o mouse sobre cada ícone para ver o que ele faz; o botão direito do mouse traz as mesmas ações.",
      ...
      "“Guardar para depois” (o ícone de arquivar, na barra abaixo da mensagem de commit) tira as mudanças marcadas da working copy e as guarda com um nome (como o stash do Git). Elas ficam na seção “Guardados para depois”, de onde você aplica de volta ou exclui — e sobrevivem ao fechar o app.",
    ],
  ...
  history: {
    ...
    points: [
      ...
      "Com um arquivo selecionado no detalhe, o ícone de autoria mostra quem escreveu cada linha daquele arquivo, naquela revisão.",
